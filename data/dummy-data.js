...
export const CATEGORIES = [
  new Category('c1', 'Italian', '#f5428d', '#FF6EB0'),
  new Category('c2', 'Quick & Easy', '#f54242', '#FF7F7F'),
  new Category('c3', 'Hamburgers', '#f5a442', '#FFC97D'),
  new Category('c4', 'German', '#f5d142', '#FFED8B'),
  new Category('c5', 'Light & Lovely', '#368dff', '#6FAAFF'),
  new Category('c6', 'Exotic', '#41d95d', '#A2E6A9'),
  new Category('c7', 'Breakfast', '#9eecff', '#A6EFFF'),
  new Category('c8', 'Asian', '#b9ffb0', '#A1F99B'),
  new Category('c9', 'French', '#ffc7ff', '#E6A3E6'),
  new Category('c10', 'Summer', '#47fced', '#A3FDF5'),
]
